...
assert.equal(isActiveMember({ ...activeMember, role: 'admin' }), true);
assert.equal(isActiveMember({ ...activeMember, role: 'super_admin' }), true);
assert.equal(isActiveMember({ ...activeMember, role: 'visitor' }), false);
