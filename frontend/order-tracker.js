...
function statusCardClass(o){if(!o.has_linked_email)return 'order-waiting';const s=String(o.status||'waiting_confirmation');if(s==='canceled'||s==='refunded')return 'order-canceled';if(s==='delivered')return 'order-delivered';if(s==='shipped')return 'order-shipped';if(s==='confirmed'||s==='processing')return 'order-confirmed';return 'order-waiting'}
